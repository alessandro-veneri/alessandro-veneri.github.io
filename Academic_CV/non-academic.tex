...
\usepackage[margin=1in]{geometry, comment} % Page layout settings
...
\usepackage{palatino} % More professional font
...
\renewcommand{\section}{\@startsection{section}{1}{0pt}%
  {-1.5ex plus -1ex minus -.2ex}% less space before
  {0.5ex plus .2ex}% less space after
  {\large\lsstyle\MakeUppercase}}% uppercase, no bold
\renewcommand{\subsection}{\@startsection{section}{1}{0pt}%
  {-1.5ex plus -1ex minus -.2ex}% less space before
  {0.5ex plus .2ex}% less space after
  {\large}}%  uppercase, no bold
\makeatother
...
\newcommand{\mytitle}[4]{
  \begin{center}
    \LARGE{#1} % Name in large bold font
  \end{center}
  \vspace{3mm}
  \noindent
  \begin{minipage}[t]{0.5\textwidth}
    #4 % Address on the left
  \end{minipage}%
  \begin{minipage}[t]{0.5\textwidth}
    \raggedleft
...
\mytitle{Alessandro Veneri}{alessandroliviopaolo@gmail.com}{linkedin.com/in/alessandroveneri/}{
\footnotesize based in Florence, Italy} % Insert your custom title
\vspace{3mm}
...
\pdfbookmark[1]{AI safety involvement}{AI-safety}
\section*{AI safety involvement}
\label{AI-safety}
\input{AI-safety}
\vspace{3mm}

\pdfbookmark[1]{Work in Progress}{WIP}
\section*{Work in progress}
\label{WIP}
\input{WIP.tex}
\vspace{3mm}

\pdfbookmark[1]{Talks}{talks}
\section*{Talks}
\label{conferences}
...
\pdfbookmark[1]{Grants \& Scholarships}{awards}
