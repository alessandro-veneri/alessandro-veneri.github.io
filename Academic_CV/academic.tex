...
\mytitle{Alessandro Veneri}{alessandro.veneri@eui.eu}{sites.google.com/view/alessandro-veneri}{\footnotesize Department of Economics \\
\footnotesize European University Institute \\ 
\footnotesize Villa La Fonte, Via delle Fontanelle, 18 \\
\footnotesize 50014, Fiesole (FI), Italy} % Insert your custom title
\vspace{3mm}
...
\pdfbookmark[1]{Fellowships}{fellowships}
\section*{Fellowships}
\input{fellowships}
\vspace{3mm}
